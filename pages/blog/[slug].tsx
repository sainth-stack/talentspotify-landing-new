...
const BlogPost = () => {
  ...
  const content = blogContent[slug as string] || defaultContent;
    ...
    <>
      ...
      <section className="py-20 bg-surface-2">
        <div className="container max-w-3xl">
          <ScrollReveal>
            <Link href="/blog" className="inline-flex items-center gap-1 text-sm text-primary font-medium hover:underline mb-6">
