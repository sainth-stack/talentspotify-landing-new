      ...
      <div className="container relative max-w-4xl text-center">
        <ScrollReveal>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/roi-calculator" className="px-8 py-4 border-2 border-primary/30 text-foreground font-semibold rounded-lg hover:border-primary hover:bg-primary/5 transition-all">Calculate Your ROI</Link>
          </div>
        </ScrollReveal>
      </div>
    </section>
    ...
    <section className="py-20 bg-background">
      <div className="container max-w-3xl text-center">
        <ScrollReveal>
          ...
          <Link href="/oracle-fusion-performance-management" className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-bold rounded-lg hover:bg-primary-dark transition-all">
