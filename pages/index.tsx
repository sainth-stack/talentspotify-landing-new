          ...
          <ScrollReveal key={product.id} delay={i * 100}>
            ...
            >
              <div className="relative overflow-hidden">
                <img src={product.img.src} alt={product.name} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={150}>
            <div className="relative">
              ...
              <img src={tab.img.src} alt={tab.headline} className="relative w-full rounded-2xl shadow-xl border border-border" loading="lazy" width={1280} height={800} />
            </div>
          </ScrollReveal>
        </div>
      </div>
