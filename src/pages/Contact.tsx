...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent("Contact from " + form.name + " (" + form.company + ")");
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <ScrollReveal>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="px-6 py-3 bg-primary text-primary-foreground font-medium rounded-lg hover:bg-primary-dark transition-all hover:-translate-y-px hover:shadow-md">
                  Send Message →
                </button>
              </form>
            </ScrollReveal>
