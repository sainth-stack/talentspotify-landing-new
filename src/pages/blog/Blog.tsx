        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {blogPosts.map((post, i) => (
            <ScrollReveal key={post.slug} delay={i * 60}>
              <Link to={`/blog/${post.slug}`} className="block bg-surface-2 rounded-2xl border border-border p-6 hover:shadow-lg hover:border-primary/20 transition-all h-full">
