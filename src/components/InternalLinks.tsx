    ...
    <div className="container">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
        {allLinks.filter(l => l.href !== exclude).map(l => (
          <Link key={l.href} to={l.href} className="flex items-center justify-between px-5 py-4 bg-background rounded-xl border border-border hover:border-primary/30 hover:shadow-md transition-all group">
